defmodule UserServiceWeb.UserAuthTest do
  use UserServiceWeb.ConnCase, async: true

  alias UserService.Accounts
  alias UserService.Accounts.Scope
  alias UserServiceWeb.UserAuth

  import UserService.AccountsFixtures

  @remember_me_cookie "_user_service_web_user_remember_me"
  @remember_me_cookie_max_age 60 * 60 * 24 * 14

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, UserServiceWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
